...
/**
 * Tracks email verification codes issued during seller signup, before a Seller account
 * exists yet. Keyed by the (lowercased) email address being verified. Mirrors
 * {@code jobhub.model.RecruiterEmailVerification}.
 */
@Entity
public class SellerEmailVerification {
    ...
    public SellerEmailVerification() {
    }

    public SellerEmailVerification(String email) {
        this.email = email;
    }
